...
_lr_productions = [
  ...
  ('type -> BOOL','type',1,'p_type','parser.py',85),
  ('idAssign -> ID = expression','idAssign',3,'p_idAssign','parser.py',89),
  ('print -> PRINT expression','print',2,'p_print','parser.py',93),
  ...
  ('expression -> expression EQUALS expression','expression',3,'p_expression_operation','parser.py',103),
  ('expression -> expression NOTEQUALS expression','expression',3,'p_expression_operation','parser.py',104),
  ('expression -> expression GTREQTHAN expression','expression',3,'p_expression_operation','parser.py',105),
  ('expression -> expression LSSEQTHAN expression','expression',3,'p_expression_operation','parser.py',106),
  ('expression -> expression > expression','expression',3,'p_expression_operation','parser.py',107),
  ('expression -> expression < expression','expression',3,'p_expression_operation','parser.py',108),
  ('expression -> expression AND expression','expression',3,'p_expression_operation','parser.py',109),
  ('expression -> expression OR expression','expression',3,'p_expression_operation','parser.py',110),
  ...
  ('expression -> INTNUM','expression',1,'p_expression_number','parser.py',122),
  ('expression -> FLOATNUM','expression',1,'p_expression_number','parser.py',123),
  ('expression -> STRINGVAL','expression',1,'p_expression_number','parser.py',124),
  ('expression -> TRUE','expression',1,'p_boolVal','parser.py',129),
  ('expression -> FALSE','expression',1,'p_boolVal','parser.py',130),
